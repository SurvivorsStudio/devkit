---
name: pr-merge
description: PR 을 squash 머지합니다. CI 통과를 기다린 뒤 요약을 확인받고, 머지 후 브랜치를 정리하고 로컬 main 을 갱신합니다. 사용자가 "/pr-merge #12", "PR 머지해" 라고 할 때 사용합니다.
...
머지는 되돌리기 어렵습니다. **번호를 잘못 읽어 다른 PR 을 머지하는 사고를 막는 단계**입니다.
...
`AskUserQuestion` 으로 확인받습니다. **승인 없이 머지하지 마십시오.**
